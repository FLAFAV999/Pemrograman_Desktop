...
Public Class Form1
    ...
    Private Sub GetFolders(ByVal PathName As TreeNode)
        ...
        Dim di As New DirectoryInfo(CStr(PathName.Tag))
        Try
            For Each nFolder In di.GetDirectories()
                ...
                With tNode
                    ...
                    .Nodes.Add("")
                End With
                If Not nFolder.Attributes.HasFlag(FileAttributes.Hidden) Then
    ...
    Private Sub lvMp3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LvMP3.SelectedIndexChanged
        ...
        If LvMP3.SelectedItems.Count = 1 Then
            Dim filePath As String = CStr(LvMP3.SelectedItems(0).Tag)
            ...
            Dim file As ID3.ID3Info = New ID3.ID3Info(filePath, True)
    ...
    Private Sub btnPlay_Click(sender As System.Object, e As System.EventArgs) Handles btnPlay.Click
        If AxWindowsMediaPlayer1.URL <> "" Then
            If btnPlay.Text = "Play" Then
                ...
                Timer1.Enabled = True
                btnPlay.Text = "Pause"
            ElseIf btnPlay.Text = "Pause" Then
    ...
    Private Sub btnEdit_Click(sender As System.Object, e As System.EventArgs) Handles btnEdit.Click
        If LvMP3.SelectedItems.Count = 0 Then Exit Sub
        ...
        Else
            ...
            End If
            Try
                Dim file As ID3.ID3Info = New ID3.ID3Info(CStr(LvMP3.SelectedItems(0).Tag), True)
